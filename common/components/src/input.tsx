        ...
        <input
          onfocus={() => {
            (element.querySelector(
              "label"
            ) as HTMLElement).style.backgroundColor = "rgba(255,255,255,0.2)";
            (element.querySelector("label") as HTMLElement).style.boxShadow =
              "0px 0px 5px rgba(0,0,0,.1)";
          }}
          onblur={() => {
            (element.querySelector(
              "label"
            ) as HTMLElement).style.backgroundColor = "transparent";
            (element.querySelector("label") as HTMLElement).style.boxShadow =
              "none";
          }}
          {...props}
