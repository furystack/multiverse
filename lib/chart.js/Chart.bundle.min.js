...
!(function(t, e) {
  ...
  var w,
    ...
    M = {
      ...
      clone: function(t) {
        ...
        if (M.isObject(t)) {
          for (var e = {}, n = Object.keys(t), i = n.length, a = 0; a < i; ++a) e[n[a]] = M.clone(t[n[a]])
          return e
        }
        return t
      },
      ...
      merge: function(t, e, n) {
        ...
        for (i = (n = n || {}).merger || M._merger, a = 0; a < u; ++a)
          if (((e = l[a]), M.isObject(e))) for (s = 0, o = (r = Object.keys(e)).length; s < o; ++s) i(r[s], t, e, n)
        return t
      },
  ...
  var D = {
      ...
      easeInOutBounce: function(t) {
        return t < 0.5 ? 0.5 * D.easeInBounce(2 * t) : 0.5 * D.easeOutBounce(2 * t - 1) + 0.5
      },
    },
    C = { effects: D }
  S.easingEffects = D
    ...
    L = {
      ...
      roundedRect: function(t, e, n, i, a, r) {
        if (r) {
          ...
          t.moveTo(e, l),
            s < u && l < d
              ? (t.arc(s, l, o, -P, -A), t.arc(u, l, o, -A, 0), t.arc(u, d, o, 0, A), t.arc(s, d, o, A, P))
              : s < u
              ? (t.moveTo(s, n), t.arc(u, l, o, -A, A), t.arc(s, l, o, A, P + A))
              : l < d
  ...
  Object.defineProperty(X.prototype, 'animationObject', {
    ...
    W._set('global', { animation: { duration: 1e3, easing: 'easeOutQuart', onProgress: H.noop, onComplete: H.noop } })
  var J = {
      animations: [],
      request: null,
        ...
        (function(t, e, n, i) {
          ...
          for (
            i &&
              ...
              rt(t, n),
              (n.endAngle = r),
              n.endAngle === n.startAngle && n.fullCircles && ((n.endAngle += at), n.fullCircles--)),
              t.beginPath(),
  ...
  W._set('global', {
    elements: {
      arc: { backgroundColor: W.global.defaultColor, borderColor: '#fff', borderWidth: 2, borderAlign: 'center' },
    },
  })
  var st = $.extend({
      _type: 'arc',
        ...
        if (s.length) {
          ...
          for (
            ...
            (n = s[t]._view),
              ...
              n.skip || ((d !== t - 1 && !o) || -1 === d ? r.moveTo(n.x, n.y) : H.canvas.lineTo(r, e._view, n), (d = t))
    ...
    var i,
      ...
      l = (function(t) {
        var e = t.borderSkipped,
          n = {}
        return e
          ? (t.horizontal ? t.base > t.x && (e = bt(e, 'left', 'right')) : t.base < t.y && (e = bt(e, 'bottom', 'top')),
            (n[e] = !0),
            n)
          : n
      })(t)
  ...
  W._set('global', {
    elements: { rectangle: { backgroundColor: mt, borderColor: mt, borderSkipped: 'bottom', borderWidth: 0 } },
  })
  var _t = $.extend({
      _type: 'rectangle',
      draw: function() {
  ...
  function Tt(t, e, n) {
    var i,
      ...
      l = H.isNullOrUndef(r)
        ...
        : -1
    return (
      H.isNullOrUndef(r) ? ((i = l * n.categoryPercentage), (a = n.barPercentage)) : ((i = r * o), (a = 1)),
  ...
  W._set('bar', {
    ...
    W._set('global', { datasets: { bar: { categoryPercentage: 0.8, barPercentage: 0.9 } } })
  var Ot = it.extend({
  ...
  var It = it.extend({
      ...
      setHoverStyle: function(t) {
        ...
        ;(t.$previousStyle = {
          ...
          (e.backgroundColor = At(n.hoverBackgroundColor, i(n.backgroundColor))),
  ...
  W._set('horizontalBar', {
    ...
    W._set('global', { datasets: { horizontalBar: { categoryPercentage: 0.8, barPercentage: 0.9 } } })
  var zt = Ot.extend({
      _getValueScaleId: function() {
        return this.getMeta().xAxisID
      },
  ...
  function Ut(t) {
    var e, n, i, a
    return (
      H.isObject(t) ? ((e = t.top), (n = t.right), (i = t.bottom), (a = t.left)) : (e = n = i = a = t),
          ...
          this._plugins.concat(a.plugins || []).forEach(function(t) {
            if (-1 === n.indexOf(t)) {
              var e = t.id,
                a = r[e]
              !1 !== a &&
                (!0 === a && (a = H.clone(W.global.plugins[e])), n.push(t), i.push({ plugin: t, options: a || {} }))
            }
          }),
          (e.descriptors = i),
          (e.id = this._cacheId),
  ...
  H.extend(tn.prototype, {
    ...
    destroy: function() {
      ...
      i && (n.unbindEvents(), H.canvas.clear(n), Ie.releaseContext(n.ctx), (n.canvas = null), (n.ctx = null)),
        Le.notify(n, 'destroy'),
  ...
  function gn(t) {
    var e, n
    return t.display
      ? ((e = H.options._parseFont(t)), (n = H.options.toPadding(t.padding)), e.lineHeight + n.height)
      : 0
  }
  function mn(t, e) {
    return H.extend(
  ...
  var yn = $.extend({
    ...
    _getLabelSizes: function() {
      ...
      return (
        e ||
          ((t._labelSizes = e = cn(t.ctx, pn(t.options.ticks), t.getTicks(), t.longestTextCache)),
      ...
      buildTicks: function() {
        var t = this,
          ...
          a = (t.ticks = (function(t, e) {
            ...
            ;(r = Math.ceil(g / m) - Math.floor(f / m)) > u && (m = H.niceNum((r * m) / u / l) * l),
              s || Sn(c)
              ...
              (r = (a - i) / m),
              (r = H.almostEquals(r, Math.round(r), m / 1e3) ? Math.round(r) : Math.ceil(r)),
              (i = Math.round(i * n) / n),
              (a = Math.round(a * n) / n),
              o.push(Sn(d) ? i : d)
  ...
  var Nn = xn.extend({
      ...
      handleTickRangeOptions: function() {
        ...
        ;(t.min = Rn(e.min, t.min)),
          ...
          t.min === t.max &&
            (0 !== t.min && null !== t.min
              ? ((t.min = Math.pow(10, Math.floor(In(t.min)) - 1)), (t.max = Math.pow(10, Math.floor(In(t.max)) + 1)))
              : ((t.min = 1), (t.max = 10))),
          null === t.min && (t.min = Math.pow(10, Math.floor(In(t.max)) - 1)),
          null === t.max && (t.max = 0 !== t.min ? Math.pow(10, Math.floor(In(t.min)) + 1) : 10),
          null === t.minNotZero &&
            (t.min > 0
              ? (t.minNotZero = t.min)
              : t.max < 1
      ...
      _configure: function() {
        ...
        xn.prototype._configure.call(t),
          0 === e &&
            ...
            (n = Fn(t.options.ticks.fontSize, W.global.defaultFontSize) / t._length)),
          (t._startValue = In(e)),
          (t._valueOffset = n),
      ...
      getPixelForValue: function(t) {
        var e = this,
          n = 0
        return (
          (t = +e.getRightValue(t)) > e.min && t > 0 && (n = (In(t) - e._startValue) / e._valueRange + e._valueOffset),
  ...
  function si(t, e) {
    ...
    return (
      ...
      null !== o ? +o : (a || 'function' != typeof r || ((o = r(e)), H.isFinite(o) || (o = n.parse(o))), o)
    )
  }
  function li(t, e) {
          ...
          (i._table = (function(t, e, n, i) {
            ...
            for (d.push(n), a = 0, r = d.length; a < r; ++a)
              (l = d[a + 1]),
                (o = d[a - 1]),
                (s = d[a]),
                (void 0 !== o && void 0 !== l && Math.round((l + o) / 2) === s) || u.push({ time: s, pos: a / (r - 1) })
            return u
  ...
  rn._date.override(
    'function' == typeof gi
      ? {
          ...
          parse: function(t, e) {
            return (
              'string' == typeof t && 'string' == typeof e ? (t = gi(t, e)) : t instanceof gi || (t = gi(t)),
    ...
    for (t.beginPath(), o = 0, s = g; o < s; ++o)
      (d = n((u = e[(l = o % g)]._view), l, i)),
        ...
        h && c
          ...
          : b && y && (m ? (h && p.push(u), c && v.push(d)) : (wi(t, p, v, b, y), (b = y = 0), (p = []), (v = [])))
        ...
        for (i = 0; i < o; ++i)
          (r = null),
            (a = (n = t.getDatasetMeta(i)).dataset) &&
              ...
              (r = { visible: t.isDatasetVisible(i), fill: vi(a, i, o), chart: t, el: a }),
            (n.$filler = r),
            l.push(r)
  ...
  var Ai = {
      ...
      beforeUpdate: function(t) {
        var e = t.options.legend,
          n = t.legend
        e
          ? (H.mergeIf(e, W.global.legend), n ? (me.configure(t, n, e), (n.options = e)) : Oi(t, e))
  ...
  var Ii = $.extend({
    ...
    fit: function() {
      var t,
        ...
        a = e.isHorizontal()
      n.display
        ? ((t = (H.isArray(n.text) ? n.text.length : 1) * H.options._parseFont(n).lineHeight + 2 * n.padding),
    ...
    draw: function() {
      ...
      if (n.display) {
        var i,
          ...
          c = t.bottom,
          f = t.right
        ;(e.fillStyle = H.valueOrDefault(n.fontColor, W.global.defaultFontColor)),
          (e.font = o.string),
          t.isHorizontal()
          ...
          (e.textBaseline = 'middle')
        var g = n.text
        if (H.isArray(g)) for (var m = 0, p = 0; p < g.length; ++p) e.fillText(g[p], 0, m, i), (m += s)
    ...
    Yi = {
      ...
      beforeUpdate: function(t) {
        var e = t.options.title,
          n = t.titleBlock
        e
          ? (H.mergeIf(e, W.global.title), n ? (me.configure(t, n, e), (n.options = e)) : Li(t, e))
